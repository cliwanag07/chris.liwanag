	...
	return (
		<div className="w-full py-8 md:py-0 bg-white dark:bg-gray-900 px-6 pt-16 sm:pt-0">
			<div className="space-y-8 text-center">
				   <div className="relative mx-auto" style={{  width: 'clamp(8.4rem, 18vw, 12rem)', height: 'clamp(8.4rem, 18vw, 12rem)' }}>
				   ...
				   <div className="space-y-3">
					   <h1 className="font-bold text-gray-900 dark:text-white" style={{ fontSize: 'clamp(2.25rem, 5vw, 3.0rem)' }}>Christopher Liwanag</h1>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<a href="mailto:chris.a.liwanag@gmail.com" className="text-md text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
							chris.a.liwanag@gmail.com
						</a>
					</div>
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-md text-gray-600 dark:text-gray-400">Ontario, CA</span>
					</div>

					{/* Social Links */}
					<div className="flex items-center justify-center space-x-4 pt-2">
						<a
							href="https://github.com/cliwanag07"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/christopher-liwanag-793b542b6/"
							target="_blank"
							rel="noopener noreferrer"
							className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
						>
